...
const mappings = [
  ...
  // Older 5 images
  { file: 'media__1784280797686.png', prod: 13, crop: 'left' }, // Jamawar & Velvet Fusion (horizontal)
  { file: 'media__1784280797459.png', prod: 10, crop: 'top' }, // Silk Jamawar
  { file: 'media__1784280797143.png', prod: 11, crop: 'top-left' }, // Burgundy Velvet (4-grid)
  { file: 'media__1784280796695.png', prod: 12, crop: 'top-left' }, // Katan Silk
  { file: 'media__1784280796338.png', prod: 14, crop: 'top' } // Jamawar Silk Fusion
];
...
async function processImages() {
  for (const m of mappings) {
    ...
    if (m.crop === 'top') {
      // Top 32% usually contains the full first image in these 3-vertical collages
